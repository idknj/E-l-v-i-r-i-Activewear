export const metadata = {
  title: "About Elviri Activewear | Our Story & Mission",
  description:
    "Discover the story behind Elviri Sportsware — premium activewear engineered for movement, quality, and modern minimalism.",
};
